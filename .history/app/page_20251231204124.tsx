...
export default function MenuPage() {
  ...
  const beers = [
    ...
    { name: "Heineken", price: "UGX 15,000" },
    { name: "Savvanah", price: "UGX 15,000" },
    { name: "Budweiser", price: "UGX 15,000" },
    { name: "Stella", price: "UGX 15,000" },
    { name: "Desperados", price: "UGX 15,000" },
    { name: "Guarana Can", price: "UGX 15,000" },
    { name: "Sparkling Water", price: "UGX 5,000" },
  ]
  ...
  const singleMalts = [
    ...
    { name: "Glenlivet 18yrs", bottlePrice: "UGX 1,400,000" },
  ...
  const redWines = [
    ...
    { name: "KWV Wines", bottlePrice: "UGX 150,000" },
  ]
  ...
  const sparklingBubbly = [
    ...
    //{ name: "Zonin Prosecco", bottlePrice: "UGX 180,000" },
  ]
  ...
  // SHISHA MENU DATA
  const shishaFlavors = [
    { name: "Single Apple", price: "UGX 35,000" },
    { name: "Double Apple", price: "UGX 40,000" },
    { name: "Grape Mint", price: "UGX 40,000" },
    { name: "Blue Mist", price: "UGX 40,000" },
    { name: "Pan Rasna", price: "UGX 40,000" },
    { name: "Lemon Mint", price: "UGX 40,000" },
    { name: "Orange Mint", price: "UGX 40,000" },
    { name: "Strawberry Mint", price: "UGX 40,000" },
    { name: "Watermelon Mint", price: "UGX 40,000" },
    { name: "Mint", price: "UGX 35,000" },
    { name: "Mixed Fruits", price: "UGX 45,000" },
    { name: "Kiwi", price: "UGX 40,000" },
    { name: "Guava", price: "UGX 40,000" },
    { name: "Bubble Gum", price: "UGX 40,000" },
    { name: "Paan Masala", price: "UGX 40,000" },
  ]

  const premiumFlavors = [
    { name: "Al Fakher Special Mix", price: "UGX 50,000" },
    { name: "Desi Murli Pan", price: "UGX 50,000" },
    { name: "Sex on the Beach", price: "UGX 50,000" },
    { name: "Strawberry Daiquiri", price: "UGX 50,000" },
    { name: "Mojito", price: "UGX 50,000" },
    { name: "Blueberry Mint", price: "UGX 50,000" },
    { name: "Rose", price: "UGX 50,000" },
          ...
          <div className="mb-16">
            ...
            <div className="mt-8 space-y-12">
              <MenuSection
                ...
                items={shishaFlavors}
                image="/hookah-shisha-with-coals-and-tobacco.jpg"
              />
              <MenuSection
                title="Premium Flavors"
                items={premiumFlavors}
                image="/premium-shisha-flavors-with-fruits.jpg"
              />
              //<MenuSection
                title="Shisha Packages"
                items={shishaPackages}
                image="/shisha-package-with-fruit-bowl.jpg"
              />
              <MenuSection
                title="Extras"
                items={extraCoals}
                image="/shisha-coals-and-accessories.jpg"
              />
            </div>
          </div>
        </div>
