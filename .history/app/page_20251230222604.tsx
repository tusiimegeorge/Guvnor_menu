...
export default function MenuPage() {
  ...
  const sparklingBubbly = [
    ...
    { name: "Belaire Regular", bottlePrice: "UGX 450,000" },
  ...
  const classicCocktails = [
    ...
    {
      name: "Mojito",
      description: "A sweet sophisticated drink that goes down smooth perfect for John Walker lover",
      price: "UGX 30,000",
    },
    {
      name: "Margarita",
    ...
    <main className="min-h-screen bg-background">
      <section className="relative border-b border-border">
        ...
        <div className="container relative mx-auto px-4 py-12 text-center">
          <div className="mx-auto mb-6 flex justify-center">
            <img src="/logo.png" alt="Guvnor Logo" className="h-32 w-auto sm:h-40" />
          </div>
          <p className="mx-auto mb-2 max-w-2xl text-xl font-semibold text-foreground text-balance sm:text-2xl">
            Whatever Happens in Guvnor Stays in Guvnor
          </p>
          <p className="mx-auto max-w-2xl text-base text-muted-foreground text-balance sm:text-lg">
            Kampala's Premier International Nightclub
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-16">
          ...
          <div className="mt-8 space-y-12">
            ...
            />
            <MenuSection title="Side Orders" items={sideOrders} image="/placeholder.svg?height=128&width=400" />
          </div>
        </div>
      </div>
      ...
      <footer className="border-t border-border bg-card py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="mb-3 text-lg font-semibold text-primary">Guvnor Club Uganda</p>
          <p className="mb-2 text-sm text-muted-foreground">Industrial Area, Kampala, Uganda</p>
          <p className="mb-4 text-xs italic text-muted-foreground">Whatever Happens in Guvnor Stays in Guvnor</p>
          <p className="text-xs text-muted-foreground">© 2025 Guvnor Club. All rights reserved.</p>
          <p className="mt-2 text-xs text-muted-foreground">
            Please drink responsibly. Must be 18+ to consume alcohol.
          </p>
          <p className="text-sm text-muted-foreground">
              Developed by <span className="font-semibold text-primary">TGT & SMJ</span>
            </p>
        </div>
