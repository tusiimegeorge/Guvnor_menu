...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen bg-background dark:bg-background">
      ...
      {/* Footer */}
      {/* CHANGED: bg-card to bg-secondary/50 and added dark mode classes */}
