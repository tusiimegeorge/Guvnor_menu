...
export default function MenuPage() {
  ...
  const classicCocktails = [
    ...
    },
    {
      name: "Martiniz",
      description:
        "Comes Delivers a clean, crisp, and predominantly dry flavor profile with botanical notes from gin, subtle herbal complexity from vermouth, and a hint of bitterness from optional garnishes like olives or lemon twist",
      price: "UGX 30,000",
    },
  ]
