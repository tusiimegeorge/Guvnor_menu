...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen bg-background dark:bg-background">
      ...
      <section className="relative border-b border-border dark:border-border">
        ...
        <div className="container relative mx-auto px-4 py-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-base text-muted-foreground text-balance sm:text-lg dark:text-muted-foreground">
            {/* ADDED: dark:text-muted-foreground for dark mode */}
      ...
      {/* Footer - FIXED: Changed from bg-card to bg-secondary/50 and added dark mode */}
      <footer className="border-t border-border dark:border-border bg-secondary/50 py-8 dark:bg-secondary/20">
        {/* CHANGED: bg-card → bg-secondary/50, ADDED: dark:border-border and dark:bg-secondary/20 */}
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-2 text-sm text-muted-foreground dark:text-muted-foreground">
            {/* ADDED: dark:text-muted-foreground */}
