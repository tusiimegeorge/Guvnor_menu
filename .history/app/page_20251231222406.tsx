...
export default function MenuPage() {
  ...
  const classicFlavors = [
    ...
    { name: "Double Apple", price: "UGX 50,000" },
    { name: "Grape Mint", price: "UGX 50,000" },
    { name: "Blue Mist", price: "UGX 50,000" },
    { name: "Pan Rasna", price: "UGX 50,000" },
    { name: "Lemon Mint", price: "UGX 50,000" },
