...
export default function MenuPage() {
  ...
  const liqueurs = [
    ...
    { name: "Don Julio 1942", bottlePrice: "UGX 2,200,000" },
    { name: "Patron Coffee", bottlePrice: "UGX 550,000" },
    { name: "Patron Silver", bottlePrice: "UGX 650,000" },
  ...
  const gin = [
    { name: "Uganda Waragi", bottlePrice: "UGX 150,000", totPrice: "UGX 4,000" },
    { name: "Uganda Waragi Lemon & Ginger", bottlePrice: "UGX 180,000", totPrice: "UGX 5,000" },
  ...
  const brandy = [
    ...
    { name: "Martel V.S.O.P", bottlePrice: "UGX 800,000" },
    { name: "Hennessy V.S.O.P", bottlePrice: "UGX 850,000", totPrice: "UGX 25,000"},
  ...
  const johnnieWalker = [
    ...
    { name: "Blue Label", bottlePrice: "UGX 2,000,000", totPrice: "UGX 70,000" },
  ...
  const singleMalts = [
    ...
    { name: "Macallan 12yrs", bottlePrice: "UGX 650,000" },
    { name: "Macallan 15yrs", bottlePrice: "UGX 1,600,000" },
    { name: "Macallan 18yrs", bottlePrice: "UGX 2,500,000" },
  ...
  const champagne = [
    ...
    { name: "Ace of Spades", bottlePrice: "UGX 3,000,000" },
    { name: "Dom Pérignon", bottlePrice: "UGX 2,500,000" },
  ...
  const sideOrders = [
    ...
    { name: "Sausages (3pcs)", description: "", price: "UGX 10,000" },
